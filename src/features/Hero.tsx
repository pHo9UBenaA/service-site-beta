...
export default function Hero() {
	return (
		<section
			className='flex min-h-screen w-full bg-center bg-cover bg-no-repeat'
			style={{
				backgroundImage: `url(${background.src})`,
			}}
		>
			<div className='flex min-h-screen w-full items-center justify-start px-10 dark:bg-black/30'>
				<div className='mt-20 flex max-w-[640px] flex-col gap-5 text-black dark:text-white'>
